...
O sistema utiliza um banco de dados online, mas é preciso executar os scripts locais:

1- Abra o **MySQL Workbench**
2- Vá em **File > Open SQL Script...** ( ou pressione ´Ctrl + Shift + O ').
3- Navegue até a subpasta **'bd-scripts'** dentro do projeto e selecione o arquivo de script do banco.
4- Execute apenas os comandos de 'INSERT' no Workbench para popular os dados necessários.
