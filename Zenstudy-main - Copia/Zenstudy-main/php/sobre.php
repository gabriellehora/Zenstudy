...
<head>
    ...
    <style>
        ...
        .btn-sair { margin-left: 30px !important; }
        ...
        .intro-text strong { color: var(--color-heading); }
...
<nav class="navbar">
    <a href="menu.php" class="logo">Zenstudy</a>
...
<div class="sobre-wrapper">
    <div class="sobre-card">
        ...
        <p class="intro-text">
            ...
            Em um mundo cheio de respostas instantâneas, acreditamos no 
        ...
        <div class="feature-list">
            <div class="feature-item">
                ...
                <p>Oferecemos métodos, organization e desafios que te ensinam <em>como</em> aprender.</p>
            </div>
