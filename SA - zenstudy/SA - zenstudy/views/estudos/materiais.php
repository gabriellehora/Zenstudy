...
require_once __DIR__ . '/../../controlleer/EstudosController.php';
    ...
    <div class="botoes-container">
        <?php if (!empty($dados['materias'])): ?>
            <?php foreach ($dados['materias'] as $materia): ?>
                <div class="menu-card">
                    <a href="/zenstudy/views/estudos/estudos.php?ano_id=<?php echo $ano_id; ?>&materia_id=<?php echo $materia['id']; ?>" class="icone-livro">
