...
require_once __DIR__ . '/../../controlleer/PesquisaController.php';
...
<form action="/zenstudy/controlleer/PesquisaController.php" method="POST" class="form-card search-form">
