...
<div class="login-container">
    ...
    <form action="/zenstudy/controlleer/LoginController.php" method="POST">
        <label>Email:</label>
        ...
        <p style="margin-top: 20px; text-align: center; font-size: 0.9rem;">
            Ainda não tem conta? 
            <a href="/zenstudy/views/cadastro.php" style="color: var(--color-secondary); font-weight: bold; text-decoration: none;">
                Cadastre-se
            </a>
        </p>
    </form>
